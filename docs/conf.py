...
project = 'WopMars'
copyright = 'since 2016, Luc Giffon, Aitor Gonzalez, Lionel Spinelli'
author = 'Luc Giffon, Aitor Gonzalez, Lionel Spinelli'
...
version = '.'.join(pandas.__version__.split('.')[0:2])
# The full version, including alpha/beta/rc tags.
release = str(pandas.__version__)
