...
project = 'WopMars'
copyright = 'since 2016. Luc Giffon, Aitor González, Lionel Spinelli'
author = 'Luc Giffon, Aitor González, Lionel Spinelli'
...
version = '.'.join(pkg_resources.require("wopmars")[0].version.split('.')[:2])
# The full version, including alpha/beta/rc tags.
release = pkg_resources.require("wopmars")[0].version
...
texinfo_documents = [
    (master_doc, 'WopMars', 'WopMars Documentation',
     author, 'WopMars', 'One line description of project.',
     'Miscellaneous'),
]
