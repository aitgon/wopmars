...
def get_current_time():
    ...
    timestamp_human = datetime.fromtimestamp(timestamp)  # human readable local time
...
def get_mtime(path):
    ...
    mtime_human = datetime.fromtimestamp(mtime_epoch)  # mtime in human readable local time
