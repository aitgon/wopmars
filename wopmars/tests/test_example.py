...
class TestExample(TestCase):
    ...
    def tearDown(self):
        ...
        subprocess.run([sys.executable, '-m', 'pip', 'uninstall', 'example', '-y', '--use-feature', 'in-tree-build'])
    ...
    def test_example(self):
        ...
        subprocess.run([sys.executable, '-m', 'pip', 'install', '{}/.'.format(self.example_dir_path), '--upgrade', '--use-feature', 'in-tree-build'])
